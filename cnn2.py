...
file_handler = logging.FileHandler('CNN2_training.log')
...
# parameters
device = 'cuda:2' # The specific gpu I used for training. Convert the device to your own gpu
num_epochs = 30 # Number of maximum epochs
batch_size = 32 # Batch size for the training/validation data
learning_rate = 1e-3
patience = 5
checkpt_file = 'checkpoint_CNN2.pt'
