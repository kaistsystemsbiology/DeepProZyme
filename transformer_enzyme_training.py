...
from deepec.data_loader import EnzymeEmbedDataset
...
if __name__ == '__main__':
    ...
    trainDataset = EnzymeEmbedDataset(train_seqs, train_ecs, explainECs)
    valDataset = EnzymeEmbedDataset(val_seqs, val_ecs, explainECs)
    testDataset = EnzymeEmbedDataset(test_seqs, test_ecs, explainECs)
    ...
    model = nn.DataParallel(model, device_ids=[3, 1, 2, 0])
